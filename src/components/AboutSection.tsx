...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-gradient-to-br from-portfolio-yellow/10 to-portfolio-blue/10 rounded-full blur-3xl"></div>
      <div className="absolute top-20 left-10 w-64 h-64 bg-portfolio-purple/5 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              <div className="pt-4">
                <Button className="flex items-center gap-2 bg-gradient-to-r from-portfolio-blue to-portfolio-purple hover:opacity-90 shadow-md hover:shadow-lg transition-all">
            ...
            <motion.div className="space-y-8" variants={itemVariants}>
              ...
              <div className="space-y-6">
                <motion.div 
                  className="bg-white/80 dark:bg-gray-800/80 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 backdrop-blur-sm hover:shadow-md transition-all"
