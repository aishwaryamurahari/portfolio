...
const HeroSection = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-portfolio-purple/30 to-portfolio-blue/30 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-portfolio-purple/20 to-portfolio-blue/20 rounded-full blur-3xl"></div>
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-portfolio-blue/10 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto px-6 py-12 md:py-0 grid md:grid-cols-2 gap-8 items-center relative z-10">
        <motion.div className="order-2 md:order-1 flex flex-col gap-6" initial="hidden" animate={isVisible ? "visible" : "hidden"} variants={containerVariants}>
          ...
          <motion.div className="mt-6" variants={itemVariants}>
            <Button onClick={scrollToProjects} variant="ghost" className="group flex items-center gap-2 text-portfolio-blue dark:text-portfolio-blue hover:bg-portfolio-light-blue dark:hover:bg-portfolio-light-blue/20">
              View My Work
