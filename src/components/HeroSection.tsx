      ...
      <div className="container mx-auto px-6 py-12 md:py-0 grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        >
          ...
          <motion.div className="mt-6" variants={itemVariants}>
            <Button 
              ...
              variant="ghost" 
              className="group flex items-center gap-2 text-portfolio-blue dark:text-portfolio-blue hover:bg-portfolio-blue/10 dark:hover:bg-portfolio-blue/20"
            >
              View My Work
        ...
        >
          <div className="relative">
            ...
            {/* Floating badge */}
            <motion.div 
              className="absolute -bottom-4 -right-4 bg-white dark:bg-gray-800 rounded-full px-4 py-2 shadow-lg border border-gray-100 dark:border-gray-700"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 0.8, duration: 0.5, type: "spring" }}
            >
              <div className="flex items-center gap-2">
                <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-portfolio-blue to-portfolio-purple">5+</span>
